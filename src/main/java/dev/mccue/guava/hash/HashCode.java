...
public abstract class HashCode {
  ...
  /**
   * Returns the first four bytes of {@code #asBytes() this hashcode's bytes}, converted to an
  ...
  /**
   * Returns the first eight bytes of {@code #asBytes() this hashcode's bytes}, converted to a
   ...
   * byte-based hashcode. Otherwise it returns {@code HashCode#asBytes}. Do <i>not</i> mutate this
   ...
   *
   * <p>This method accepts the exact format generated by {@code #toString}. If you require more
   * lenient {@code base 16} decoding, please use {@code dev.mccue.guava.io.BaseEncoding#decode}
   * (and pass the result to {@code #fromBytes}).
   *
   * @since 15.0
   */
  ...
  /**
   * Returns {@code true} if {@code object} is a {@code HashCode} instance with the identical byte
  ...
  /**
   * Returns a string containing each byte of {@code #asBytes}, in order, as a two-digit unsigned
   * hexadecimal number in lower case.
   *
   * <p>Note that if the output is considered to be a single hexadecimal number, whether this string
   * is big-endian or little-endian depends on the byte order of {@code #asBytes}. This may be
