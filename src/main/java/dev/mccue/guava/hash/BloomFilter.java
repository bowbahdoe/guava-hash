...
import dev.mccue.guava.hash.BloomFilterStrategies.LockFreeBitArray;
 ...
 * that {@code #mightContain(Object)} will erroneously return {@code true} for an object that
 * has not actually been put in the {@code BloomFilter}.
 *
 * <p>Bloom filters are serializable. They also support a more compact serial representation via the
 * {@code #writeTo} and {@code #readFrom} methods. Both serialized forms will continue to be
...
public final class BloomFilter<T extends @Nullable Object> implements Predicate<T>, Serializable {
  ...
  /**
   * @deprecated Provided only to satisfy the {@code Predicate} interface; use {@code #mightContain}
   *     instead.
   */
  @Deprecated
  @Override
  ...
  /**
   * Puts an element into this {@code BloomFilter}. Ensures that subsequent invocations of {@code
  ...
  /**
   * Returns the probability that {@code #mightContain(Object)} will erroneously return {@code
   * true} for an object that has not actually been put in the {@code BloomFilter}.
   *
   * <p>Ideally, this number should be close to the {@code fpp} parameter passed in {@code
  ...
  /**
   * Returns a {@code Collector} expecting the specified number of insertions, and yielding a {@code
   ...
   * ensuring proper serialization and deserialization, which is important since {@code #equals}
  ...
  /**
   * Creates a {@code BloomFilter} with the expected number of insertions and expected false
  ...
  /**
   * Creates a {@code BloomFilter} with the expected number of insertions and a default expected
   ...
   * serialization.
   *
   * <p>Use {@code #readFrom(InputStream, Funnel)} to reconstruct the written BloomFilter.
   */
  ...
  /**
   * Reads a byte stream, which was written by {@code #writeTo(OutputStream)}, into a {@code
   * BloomFilter}.
   *
   ...
   *     appear to be a BloomFilter serialized using the {@code #writeTo(OutputStream)} method.
   */
